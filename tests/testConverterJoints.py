...
class TestConverterJoints(ConverterTestCase):
    ...
    def test_fixed_planar_joints(self):
        ...
        self.assertEqual(physics_joint.GetLocalRot0Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0, 0, 0)))
        self.assertEqual(physics_joint.GetLocalRot1Attr().Get(), Gf.Quatf(1, Gf.Vec3f(0, 0, 0)))
        ...
        self.assertTrue(Gf.IsClose(physics_joint.GetLocalPos1Attr().Get(), Gf.Vec3f(0, 0, 0), self.tolerance))
        self.assertEqual(physics_joint.GetLocalRot0Attr().Get(), Gf.Quatf(0, Gf.Vec3f(-1, 0, 0)))
        self.assertEqual(physics_joint.GetLocalRot1Attr().Get(), Gf.Quatf(0, Gf.Vec3f(-1, 0, 0)))
        ...
        self.assertTrue(Gf.IsClose(physics_joint.GetLocalPos1Attr().Get(), Gf.Vec3f(0, 0, 0), self.tolerance))
        self.assertEqual(physics_joint.GetLocalRot0Attr().Get(), Gf.Quatf(0, Gf.Vec3f(0, -1, 0)))
        self.assertEqual(physics_joint.GetLocalRot1Attr().Get(), Gf.Quatf(0, Gf.Vec3f(0, -1, 0)))
        ...
        self.assertTrue(Gf.IsClose(physics_joint.GetLocalPos0Attr().Get(), Gf.Vec3f(1, 0, 0), self.tolerance))
        self.assertTrue(Gf.IsClose(physics_joint.GetLocalPos1Attr().Get(), Gf.Vec3f(0, 0, 0), self.tolerance))
        self.assertEqual(physics_joint.GetLocalRot0Attr().Get(), Gf.Quatf(0.7707607, Gf.Vec3f(0, -0.6102548, 0.18307644)))
        self.assertEqual(physics_joint.GetLocalRot1Attr().Get(), Gf.Quatf(0.7707607, Gf.Vec3f(0, -0.6102548, 0.18307644)))
