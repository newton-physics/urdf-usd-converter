...
class TestJoints(ConverterTestCase):
    def test_revolute_joints(self):
        ...
        self.assert_rotation_almost_equal(Gf.Rotation(revolute_joint.GetLocalRot0Attr().Get()), Gf.Rotation(Gf.Quatf(1, 0, 0, 0)), 1e-6)
        ...
        self.assert_rotation_almost_equal(
            Gf.Rotation(revolute_joint.GetLocalRot0Attr().Get()), Gf.Rotation(Gf.Quatf(0.9887711, 0, 0, 0.14943811)), 1e-6
        )
        self.assert_rotation_almost_equal(Gf.Rotation(revolute_joint.GetLocalRot1Attr().Get()), Gf.Rotation(Gf.Quatf(1, 0, 0, 0)), 1e-6)
        self.assertEqual(revolute_joint.GetAxisAttr().Get(), UsdPhysics.Tokens.y)
        ...
        self.assertTrue(Gf.IsClose(revolute_joint.GetLocalPos1Attr().Get(), Gf.Vec3f(0, 0, 0), 1e-6))
        self.assert_rotation_almost_equal(
            Gf.Rotation(revolute_joint.GetLocalRot0Attr().Get()), Gf.Rotation(Gf.Quatf(0.9859915, -0.011197348, -0.14901796, -0.07408829)), 1e-6
        )
        self.assert_rotation_almost_equal(Gf.Rotation(revolute_joint.GetLocalRot1Attr().Get()), Gf.Rotation(Gf.Quatf(1, 0, 0, 0)), 1e-6)
        self.assertEqual(revolute_joint.GetAxisAttr().Get(), UsdPhysics.Tokens.y)
        ...
        self.assertTrue(Gf.IsClose(revolute_joint.GetLocalPos1Attr().Get(), Gf.Vec3f(0, 0, 0), 1e-6))
        self.assert_rotation_almost_equal(
            Gf.Rotation(revolute_joint.GetLocalRot0Attr().Get()), Gf.Rotation(Gf.Quatf(0.9971888, -0.07492986, 9.7144515e-17, -6.2450045e-17)), 1e-6
        )
        self.assert_rotation_almost_equal(Gf.Rotation(revolute_joint.GetLocalRot1Attr().Get()), Gf.Rotation(Gf.Quatf(1, 0, 0, 0)), 1e-6)
        self.assertEqual(revolute_joint.GetAxisAttr().Get(), UsdPhysics.Tokens.y)
        self.assertAlmostEqual(revolute_joint.GetLowerLimitAttr().Get(), -17.188734, places=6)
    ...
    def test_fixed_prismatic_joints(self):
        ...
        self.assert_rotation_almost_equal(Gf.Rotation(prismatic_joint.GetLocalRot0Attr().Get()), Gf.Rotation(Gf.Quatf(1, 0, 0, 0)), 1e-6)
        self.assert_rotation_almost_equal(Gf.Rotation(prismatic_joint.GetLocalRot1Attr().Get()), Gf.Rotation(Gf.Quatf(1, 0, 0, 0)), 1e-6)
    ...
    def test_fixed_planar_joints(self):
        ...
        self.assert_rotation_almost_equal(Gf.Rotation(physics_joint.GetLocalRot0Attr().Get()), Gf.Rotation(Gf.Quatf(1, 0, 0, 0)), 1e-6)
        self.assert_rotation_almost_equal(Gf.Rotation(physics_joint.GetLocalRot1Attr().Get()), Gf.Rotation(Gf.Quatf(1, 0, 0, 0)), 1e-6)
        ...
        self.assertTrue(Gf.IsClose(physics_joint.GetLocalPos1Attr().Get(), Gf.Vec3f(0, 0, 0), 1e-6))
        self.assert_rotation_almost_equal(Gf.Rotation(physics_joint.GetLocalRot0Attr().Get()), Gf.Rotation(Gf.Quatf(0, -1, 0, 0)), 1e-6)
        self.assert_rotation_almost_equal(Gf.Rotation(physics_joint.GetLocalRot1Attr().Get()), Gf.Rotation(Gf.Quatf(0, -1, 0, 0)), 1e-6)
